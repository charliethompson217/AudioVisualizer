...
export default function App() {
    ...
    function handleSongSelection(e) {
        ...
        if (url.endsWith('.mid')) {
            setMidiFile(url);
            setMp3File(null);  // Clear mp3File if a MIDI file is selected
        } else {
            setMp3File(url);
            setMidiFile(null); // Clear midiFile if an MP3 file is selected
        }
    }
    ...
    function handleFileUpload(e) {
        ...
        if (file) {
            ...
            if (fileName.endsWith('.mid') || fileName.endsWith('.midi')) {
                ...
                setMidiFile(null);  // Clear midiFile
            }
        }
    }
                                    ...
                                    <div>
                                        <label>
                                            ...
                                            <input
                                                ...
                                                value={attackTime}
                                                onChange={(e) =>
                                                    setAttackTime(parseFloat(e.target.value))
                                                }
                                                className="harmonic-slider"
                                            />
                                        </label>
                                    ...
                                    <div>
                                        <label>
                                            ...
                                            <input
                                                ...
                                                value={decayTime}
                                                onChange={(e) =>
                                                    setDecayTime(parseFloat(e.target.value))
                                                }
                                                className="harmonic-slider"
                                            />
                                        </label>
                                    ...
                                    <div>
                                        <label>
                                            ...
                                            <input
                                                ...
                                                value={sustainLevel}
                                                onChange={(e) =>
                                                    setSustainLevel(parseFloat(e.target.value))
                                                }
                                                className="harmonic-slider"
                                            />
                                        </label>
                                    ...
                                    <div>
                                        <label>
                                            ...
                                            <input
                                                ...
                                                value={releaseTime}
                                                onChange={(e) =>
                                                    setReleaseTime(parseFloat(e.target.value))
                                                }
                                                className="harmonic-slider"
                                            />
                                        </label>
